function fluxes = refraction_layer_fluxes(rlayer_coefs,fcoefs)
...
i               =   rlayer_coefs.i_refrac;

% u0 and taustar
u0              =   rlayer_coefs.u0(1:end-1,:);
taustar         =   rlayer_coefs.taustar(1:end-1,:);

% direct beam transmission
Tdrs            =   exp(-taustar./u0);
Tdrs(i+1:end,:) =   fcoefs.Tfa_u0.*Tdrs(i+1:end,:);
